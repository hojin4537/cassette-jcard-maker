...
export const LabelEditor: React.FC<LabelEditorProps> = ({ onBack }) => {
  ...
  const handleDownload = async (format: 'png' | 'jpg' = 'png') => {
    ...
    const canvas = createHighResCanvas('label');
    ...
    downloadCanvas(canvas, `label-${Date.now()}`, format);
  };
  ...
  return (
    <div className="label-editor">
      <div className="editor-header">
        ...
        <h1 className="editor-title">라벨 스티커 에디터</h1>
        {editorState && (
